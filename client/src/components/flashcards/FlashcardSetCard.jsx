...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return (
    <div
      className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:borer-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between'
      onClick={handleStudyNow}
    >
      <div className='space-y-4'>
        {/* icon and title  */}
        <div className='flex items-center gap-4'>
          <div className='shrink-0 w-12 h-12 rounded-xl bg-linear-to-br form-emerald-100 to-teal-500 flex items-center justify-center'>
